...
This API has been updated on 08/15/2023 07:34:48 UTC, with a total of **31844** titles indexed.

|              Provider |     Code      | Count  |
| --------------------: | :-----------: | :----- |
|                 aniDb |    `anidb`    | 12913 |
|               AniList |   `anilist`   | 17386 |
...
|           MyAnimeList | `myanimelist` | 25264 |
|                Notify |    `notify`   | 15857 |
|            Otak Otaku |  `otakotaku`  | 2544 |
|             Shikimori |  `shikimori`  | 25264 |
