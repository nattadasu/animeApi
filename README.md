...
<!-- updated -->
Last updated: 12 May 2024 05:16:41 UTC
<!-- /updated -->
...
| :----------------- | ------------: | --------: |
| aniDB              |       `anidb` |     13244 |
| AniList            |     `anilist` |     19894 |
| Anime-Planet       | `animeplanet` |     23726 |
| aniSearch          |   `anisearch` |     18504 |
| Annict             |      `annict` |     10087 |
| IMDb               |        `imdb` |      2267 |
| Kaize              |       `kaize` |     22962 |
| Kitsu              |       `kitsu` |     20196 |
| LiveChart          |   `livechart` |     11201 |
| MyAnimeList        | `myanimelist` |     27010 |
| Nautiljon          |   `nautiljon` |      8200 |
| Notify.moe         |      `notify` |     16217 |
| Otak Otaku         |   `otakotaku` |      2664 |
| Shikimori          |   `shikimori` |     27010 |
...
```json
{
  ...
  "updated": {
    "timestamp": 1715491001,
    "iso": "2024-05-12T05:16:41.250215+00:00"
  },
  "contributors": [
    "nattadasu"
  ],
...
<!-- updated-txt -->
```txt
Updated on 05/12/2024 05:16:41 UTC
```
<!-- /updated-txt -->
