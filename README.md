...
This API has been updated on 06/20/2023 05:32:58 UTC, with a total of **31475** titles indexed.

|              Provider |     Code      | Count  |
| --------------------: | :-----------: | :----- |
|                 aniDb |    `anidb`    | 12845 |
|               AniList |   `anilist`   | 17233 |
...
|           MyAnimeList | `myanimelist` | 24870 |
|                Notify |    `notify`   | 15789 |
|            Otak Otaku |  `otakotaku`  | 2528 |
|             Shikimori |  `shikimori`  | 24870 |
