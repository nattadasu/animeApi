...
<!-- updated -->
Last updated: 07 September 2024 05:17:01 UTC
<!-- /updated -->
...
| :----------------- | ------------: | --------: |
| aniDB              |       `anidb` |     13427 |
| AniList            |     `anilist` |     20436 |
| Anime-Planet       | `animeplanet` |     23979 |
| aniSearch          |   `anisearch` |     18804 |
| Annict             |      `annict` |     10169 |
| IMDb               |        `imdb` |      2269 |
| Kaize              |       `kaize` |     22998 |
| Kitsu              |       `kitsu` |     20503 |
| LiveChart          |   `livechart` |     11357 |
| MyAnimeList        | `myanimelist` |     27674 |
| Nautiljon          |   `nautiljon` |      8337 |
| Notify.moe         |      `notify` |     16322 |
| Otak Otaku         |   `otakotaku` |      2724 |
| Shikimori          |   `shikimori` |     27674 |
| Shoboi/Syobocal    |      `shoboi` |      4860 |
...
```json
{
  ...
  "updated": {
    "timestamp": 1725686221,
    "iso": "2024-09-07T05:17:01.991614+00:00"
  },
  "contributors": [
    "nattadasu"
  ],
...
<!-- updated-txt -->
```txt
Updated on 09/07/2024 05:17:01 UTC
```
<!-- /updated-txt -->
