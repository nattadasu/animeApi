...
<!-- updated -->
Last updated: 26 September 2023 05:24:29 UTC
<!-- /updated -->
...
| :----------------- | ------------: | --------: |
| aniDB              |       `anidb` |     12889 |
| AniList            |     `anilist` |     19120 |
| Anime-Planet       | `animeplanet` |     23040 |
| aniSearch          |   `anisearch` |     17976 |
| Annict             |      `annict` |      8962 |
| IMDb               |        `imdb` |      2259 |
| Kaize              |       `kaize` |     22822 |
| Kitsu              |       `kitsu` |     19378 |
| LiveChart          |   `livechart` |     10885 |
| MyAnimeList        | `myanimelist` |     25574 |
| Nautiljon          |   `nautiljon` |      7952 |
| Notify.moe         |      `notify` |     15891 |
| Otak Otaku         |   `otakotaku` |      2477 |
| Shikimori          |   `shikimori` |     25574 |
| Shoboi/Syobocal    |      `shoboi` |      4732 |
| Silver Yasha       | `silveryasha` |      4048 |
| The Movie Database |  `themoviedb` |       412 |
| Trakt              |       `trakt` |      4436 |
|                    |               |           |
|                    |     **Total** | **32008** |
<!-- /counters -->
...
```json
{
  ...
  "updated": {
    "timestamp": 1695705869,
    "iso": "2023-09-26T05:24:29.747397+00:00"
  },
  "contributors": [
    "nattadasu"
  ],
...
<!-- updated-txt -->
```txt
Updated on 09/26/2023 05:24:29 UTC
```
<!-- /updated-txt -->
