...
<!-- updated -->
Last updated: 24 August 2024 05:18:22 UTC
<!-- /updated -->
...
| Anime-Planet       | `animeplanet` |     23962 |
| aniSearch          |   `anisearch` |     18764 |
| Annict             |      `annict` |     10407 |
| IMDb               |        `imdb` |      2269 |
| Kaize              |       `kaize` |     23006 |
| Kitsu              |       `kitsu` |     20468 |
| LiveChart          |   `livechart` |     11339 |
| MyAnimeList        | `myanimelist` |     27606 |
| Nautiljon          |   `nautiljon` |      8308 |
| Notify.moe         |      `notify` |     16323 |
| Otak Otaku         |   `otakotaku` |      2715 |
| Shikimori          |   `shikimori` |     27606 |
| Shoboi/Syobocal    |      `shoboi` |      5016 |
...
```json
{
  ...
  "updated": {
    "timestamp": 1724476702,
    "iso": "2024-08-24T05:18:22.551163+00:00"
  },
  "contributors": [
    "nattadasu"
  ],
...
<!-- updated-txt -->
```txt
Updated on 08/24/2024 05:18:22 UTC
```
<!-- /updated-txt -->
