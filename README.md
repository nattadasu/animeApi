...
This API has been updated on 07/22/2023 07:40:50 UTC, with a total of **31663** titles indexed.

|              Provider |     Code      | Count  |
| --------------------: | :-----------: | :----- |
|                 aniDb |    `anidb`    | 12892 |
|               AniList |   `anilist`   | 17324 |
...
|           MyAnimeList | `myanimelist` | 25099 |
|                Notify |    `notify`   | 15834 |
|            Otak Otaku |  `otakotaku`  | 2536 |
|             Shikimori |  `shikimori`  | 25099 |
