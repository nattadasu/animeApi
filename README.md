...
This API has been updated on 05/22/2023 05:30:57 UTC, with a total of **31150** titles indexed.
...
|                 Kaize |    `kaize`    | 24123 |
|                 Kitsu |    `kitsu`    | 18985 |
|             LiveChart |  `livechart`  | 10656 |
|           MyAnimeList | `myanimelist` | 24573 |
|                Notify |    `notify`   | 15722 |
|            Otak Otaku |  `otakotaku`  | 2507 |
|             Shikimori |  `shikimori`  | 24573 |
